...
var product = {
  ...
  */
  ...
  function addInventory(prodObj,number) {
    prodObj.inventory += number;
    console.log(number + ' ' + prodObj.name + 's added to the inventory');
  };
  ...
  */
  ...
  function processSale(prodObj,numSold) {
    prodObj.inventory -= numSold;
    var totalSale = 'Total sale: $' + (numSold * prodObj.unit_price);
    console.log(numSold + ' ' + prodObj.name + 's' + ' sold');
    return totalSale;
  };
  ...
  "Total sale: $20"
  */
  console.log(processSale(product,2));
